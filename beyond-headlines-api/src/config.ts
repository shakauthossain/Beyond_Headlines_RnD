...
export const config = {
  ...
  claudeSonnetModel:
    process.env.CLAUDE_SONNET_MODEL || "anthropic/claude-sonnet-4-5",
  claudeHaikuModel:
    process.env.CLAUDE_HAIKU_MODEL || "anthropic/claude-haiku-4-5",
  perplexitySonarModel:
    process.env.PERPLEXITY_SONAR_MODEL || "perplexity/sonar",
  perplexitySonarStandardModel: "perplexity/sonar",
